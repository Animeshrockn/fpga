...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 5 \
			corename kernel_gemm_ctrl_bus_axilite \
			name kernel_gemm_ctrl_bus_s_axi \
			ports {$port_ctrl_bus} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_gemm_ctrl_bus_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    op interface \
    max_latency -1 \ 
    delay_budget 2.91375 \ 
    is_flushable 0 \ 
    name {kernel_gemm_func_bus_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'func_bus'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_gemm_func_bus_m_axi
}
