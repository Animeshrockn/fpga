...
void XKernel_gemm_Set_C_V(XKernel_gemm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKernel_gemm_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_GEMM_CONTROL_ADDR_C_V_DATA, Data);
}

u32 XKernel_gemm_Get_C_V(XKernel_gemm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKernel_gemm_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_GEMM_CONTROL_ADDR_C_V_DATA);
    return Data;
}

void XKernel_gemm_Set_A_V(XKernel_gemm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKernel_gemm_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_GEMM_CONTROL_ADDR_A_V_DATA, Data);
}

u32 XKernel_gemm_Get_A_V(XKernel_gemm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKernel_gemm_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_GEMM_CONTROL_ADDR_A_V_DATA);
    return Data;
}

void XKernel_gemm_Set_B_V(XKernel_gemm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKernel_gemm_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_GEMM_CONTROL_ADDR_B_V_DATA, Data);
}

u32 XKernel_gemm_Get_B_V(XKernel_gemm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKernel_gemm_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_GEMM_CONTROL_ADDR_B_V_DATA);
    return Data;
}
