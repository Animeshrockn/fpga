...
set ID 658
set hasByteEnable 0
set MemName kernel_gemm_localdEe
...
set ID 659
set hasByteEnable 0
set MemName kernel_gemm_localeOg
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 128
...
set ID 660
set hasByteEnable 0
set MemName kernel_gemm_localenQ
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 128
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_gemm_gmem_m_axi
}
