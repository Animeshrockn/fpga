...
void compute(int flag, TYPE_WIDER local_A[T][T/WIDTH_FACTOR], TYPE_WIDER local_B[T][T/WIDTH_FACTOR], TYPE_WIDER local_C[T][T/WIDTH_FACTOR], TYPE alpha){
#pragma HLS INLINE off
...
void kernel_gemm(TYPE_WIDER C[NI * (NJ/WIDTH_FACTOR)], TYPE_WIDER A[NI * (NK/WIDTH_FACTOR)], TYPE_WIDER B[NI * (NK/WIDTH_FACTOR)], const float alpha, const float beta) {
