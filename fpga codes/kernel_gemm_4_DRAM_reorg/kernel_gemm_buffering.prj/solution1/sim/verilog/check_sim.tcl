...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kernel_gemm.autotvin_gmem.dat"
         "c.kernel_gemm.autotvin_C_V.dat"
         "c.kernel_gemm.autotvin_A_V.dat"
         "c.kernel_gemm.autotvin_B_V.dat"
         "c.kernel_gemm.autotvin_alpha.dat"
         "c.kernel_gemm.autotvin_beta.dat"
         "c.kernel_gemm.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kernel_gemm.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
