...
AUTOPILOT_ROOT := /local-scratch/Xilinx/Vivado/2020.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /local-scratch/Xilinx/Vivado/2020.1/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/kernel_gemm_test.cpp_pre.cpp.tb.o : kernel_gemm_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kernel_gemm_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/kernel_gemm.cpp_pre.cpp.tb.o : kernel_gemm.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kernel_gemm.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
